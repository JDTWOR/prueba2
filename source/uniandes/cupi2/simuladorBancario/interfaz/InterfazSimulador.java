...
public class InterfazSimulador extends JFrame {
  ...
  public InterfazSimulador() {
    ...
    panelTransacciones
        .setBorder(new CompoundBorder(new EmptyBorder(0, 0, 5, 0), new TitledBorder("Informaci�n Bancaria")));
  ...
  public void actualizar() {
    ...
    panelCDT.actualizarSaldoCDT(formatearValor(cuenta.darCDT().calcularValorPresente(cuenta.darMesActual())) + "   ["
        + (cuenta.darCDT().darInteresMensual() * 100) + "%]");
    ...
    if (pMonto != null) {
      try {
        ...
        if (monto > 0 && interes > 0) {
          ...
          JOptionPane.showMessageDialog(this, "Debe  ingresar valores positivos.", "Invertir en CDT",
              JOptionPane.ERROR_MESSAGE);
        }
      } catch (Exception e) {
        JOptionPane.showMessageDialog(this, "Se ingres� un monto de dinero o inter�s inv�lido.", "Invertir en CDT",
            JOptionPane.ERROR_MESSAGE);
      }
    }
  }
   ...
   * <b>post: </b> Se retir� un monto de dinero de la cuenta de ahorros del
   * cliente.
   * 
  ...
  public void retirarAhorros(String pMonto) {
    try {
      ...
      JOptionPane.showMessageDialog(this, "Se ingres� un monto de dinero inv�lido.", "Retirar",
          JOptionPane.ERROR_MESSAGE);
   ...
   * <b>post: </b> Se consign� el monto de dinero a la cuenta de ahorros del
   * cliente.
   * 
   * @param pMonto Monto de dinero a consignar en la cuenta de ahorros del
   *               cliente.
   */
  public void consignarAhorros(String pMonto) {
    try {
      ...
      JOptionPane.showMessageDialog(this, "Se ingres� un monto de dinero inv�lido.", "Consignar",
          JOptionPane.ERROR_MESSAGE);
   ...
   * <b>post: </b> Se retir� de la cuenta corriente del cliente el monto
   * especificado.
   * 
   ...
   * <b>post: </b> Se consign� el monto especificado en la cuenta corriente del
   * cliente.
   * 
